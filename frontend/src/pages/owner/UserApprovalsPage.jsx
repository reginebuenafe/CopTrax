...
import {
  ...
  LuUserPlus, LuFlaskConical, LuScale,
} from "react-icons/lu";
...
function CreateStaffModal({ onClose, onCreated }) {
  const [form, setForm] = useState({
    ...
    address: "", role_name: "Weigher", password: "", confirm: "",
  });
  ...
  const inputCls = "w-full px-4 py-2.5 rounded-xl border border-beige-dark bg-white text-sm text-brown-dark " +
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-beige-dark/20">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-green-pale rounded-xl flex items-center justify-center">
              <LuUserPlus className="w-4.5 h-4.5 text-green-dark" />
            </div>
            <div>
